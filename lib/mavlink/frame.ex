defmodule MAVLink.Frame do
  ...
  @spec binary_to_frame_and_tail(binary) ::
          {MAVLink.Frame.t(), binary} | {nil, binary} | :not_a_frame
  # MAVLink version 1
  ...
  @spec validate_and_unpack(MAVLink.Frame.t(), module) ::
          {:ok, MAVLink.Frame.t()} | :failed_to_unpack | :checksum_invalid | :unknown_message
  def validate_and_unpack(
        frame = %MAVLink.Frame{message_id: message_id, version: version, payload: payload},
        dialect
      ) do
